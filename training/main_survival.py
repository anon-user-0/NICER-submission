...
PROTO_MODELS = ['PANTHER', 'OT', 'H2T', 'ProtoCount',
                'DeepSets', 'NonParam_Local_Groups', 'InfiniteGPFA',
                'KMeans','DPMeans','AdaptiveGMM']
...
parser.add_argument('--model_type', type=str, choices=['H2T', 'ABMIL', 'TransMIL', 'DSMIL', 'SumMIL', 'DeepSets',
                                                       ...
                                                       'ILRA', 'NonParam', 'NonParam_Global_Groups', 'NonParam_Local_Groups',
                                                       'InfiniteGPFA', 'NonParam_Local_Groups_Control','KMeans','DPMeans','AdaptiveGMM'],
                    default='ABMIL',
                    help='type of model')
