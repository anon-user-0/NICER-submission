...
@dataclass
class NonParam_Local_Groups_Config(PretrainedConfig):
    in_dim: int = 768
    n_classes: int = 2
    heads: int = 1
    em_iter: int = 3
    ...
    proto_path: str = '.'
    fix_proto: bool = True
    load_compression: bool = True
    compression_path: str = '.'
    sampling_num: int = 10000
    similarity_lr: float = 0.1
    top_k: float = 3
    
@dataclass
class InfiniteGPFA_Config(PretrainedConfig):
    in_dim: int = 768
    n_classes: int = 2
    heads: int = 1
    em_iter: int = 3
...
@dataclass
class DeepSetsConfig(PretrainedConfig):
    in_dim: int = 768
    n_classes: int = 2
    out_size: int = 3
    load_proto: bool = True
...
@dataclass
class KMeansConfig(PretrainedConfig):
    in_dim: int = 768
    n_classes: int = 2
    out_size: int = 3
    load_proto: bool = True
...
@dataclass
class DPMeansConfig(PretrainedConfig):
    in_dim: int = 768
    n_classes: int = 2
    out_size: int = 3
    load_proto: bool = True
...
@dataclass
class AdaptiveGMMConfig(PretrainedConfig):
    in_dim: int = 768
    n_classes: int = 2
    out_size: int = 3
    load_proto: bool = True
...
@dataclass
class TransformerEmbConfig(PretrainedConfig):
    in_dim: int = 129
    n_classes: int = 4
    p: int = 32
    nhead: int = 1
...
@dataclass
class TransformerMLPEmbConfig_SharedPost(PretrainedConfig):
    in_dim: int = 129
    n_classes: int = 4
    shared_embed_dim: int = 64
    indiv_embed_dim: int = 32
